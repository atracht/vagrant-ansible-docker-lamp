...
/usr/bin/pacman -S --noconfirm linux-headers docker docker-compose ufw mysql-python ansible rsync virtualbox-guest-utils virtualbox-guest-dkms nfs-utils
...
/usr/bin/usermod --append --groups vagrant,vboxsf,docker vagrant
